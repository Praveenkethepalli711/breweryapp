...
DATABASES = {
    'default': {
        ...
        'NAME': 'Pandu',
        'CLIENT': {
            'host': 'mongodb+srv://190030921cse:mBhkEmgnUWlNn3oq@cluster0.g1orulv.mongodb.net/Praveen',  # Add the database name to the host
            'username': '190030921cse',
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER':'postgres',
        'PASSWORD':'EBf65Ddg4A16cg5-*Ab3232g*cf51GAd',
